...
public:
    ...
    void updateGridCounter(const utils::Vec3f& pos, const GridType& from_type, const GridType& to_type);
...
protected:
    ...
    virtual void triggerJumpingEdge(const utils::Vec3i& id_g, const GridType& from_type, const GridType& to_type) = 0;
