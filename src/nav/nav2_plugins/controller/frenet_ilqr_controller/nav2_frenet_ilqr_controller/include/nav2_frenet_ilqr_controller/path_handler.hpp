...
#ifndef NAV2_FRENET_ILQR_CONTROLLER__PATH_HANDLER_HPP_
#define NAV2_FRENET_ILQR_CONTROLLER__PATH_HANDLER_HPP_
...
/**
 * @class nav2_frenet_ilqr_controller::PathHandler
...
public:
  /**
   * @brief Constructor for nav2_frenet_ilqr_controller::PathHandler
   */
  PathHandler(
  ...
  /**
   * @brief Destrructor for nav2_frenet_ilqr_controller::PathHandler
   */
  ~PathHandler() = default;
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("FrenetILQRPathHandler")};
...
#endif  // NAV2_FRENET_ILQR_CONTROLLER__PATH_HANDLER_HPP_
