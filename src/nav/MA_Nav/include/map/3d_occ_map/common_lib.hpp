...
namespace rog_map {
    ...
    static double computePathLength(const utils::vec_E<utils::Vec3f>& path) {
        if (path.size() < 2) {
            return 0.0;
        }
        double len = 0.0;
    ...
    static utils::Vec3f lineBoxIntersectPoint(const utils::Vec3f& pt, const utils::Vec3f& pos,
    ...
    static bool GetIntersection(float fDst1, float fDst2, utils::Vec3f P1, utils::Vec3f P2,
                                utils::Vec3f& Hit) {
    ...
    static bool InBox(utils::Vec3f Hit, utils::Vec3f B1, utils::Vec3f B2, const int Axis) {
    ...
    static bool lineIntersectBox(utils::Vec3f L1, utils::Vec3f L2, utils::Vec3f B1,
                                 utils::Vec3f B2, utils::Vec3f& Hit) {
