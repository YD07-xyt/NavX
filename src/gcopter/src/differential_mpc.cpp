#include "../include/controller/differential_mpc.h"
...
Mpc::Mpc() {
    ...
    u_max_ = 4;
    w_max_ = 2;
    std::vector<double> weights = {10,10,1,1,1}; //Q,R
    u_min_ = - u_max_;
    w_min_ = - w_max_;
    
    Q_ =  casadi::DM::zeros(3,3); //索引之前初始化size
...
casadi::Function Mpc::setKinematicEquation() {
