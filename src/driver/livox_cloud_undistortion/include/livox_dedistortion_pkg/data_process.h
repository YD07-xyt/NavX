...
struct MeasureGroup {
  sensor_msgs::msg::PointCloud2::SharedPtr lidar;
  std::vector<sensor_msgs::msg::Imu::SharedPtr> imu;
};
...
class ImuProcess {
 public:
  ...
  void IntegrateGyr(const std::vector<sensor_msgs::msg::Imu::SharedPtr> &v_imu);
