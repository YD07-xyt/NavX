...
class SDFmap
{
  ...
  public:
    ...
    grid_interval_=map_config.gridmap_interval;
    ...
    //vis_timer_ = nh_.createTimer(ros::Duration(0.5), &SDFmap::visCallback, this);
      ...
      detection_range_=map_config.detection_range;
      global_x_lower_=map_config.global_x_lower;
      global_x_upper_=map_config.global_x_upper;
      global_y_lower_=map_config.global_y_lower;
      global_y_upper_=map_config.global_y_upper;
      if_perspective_=map_config.if_perspective;
      if_cirSupRaycast_=map_config.if_cirSupRaycast;
      hrz_limited_=map_config.hrz_limited;
      hrz_laser_range_dgr_=map_config.hrz_laser_range_dgr;
